...
public class logoBookShopPanel extends JPanel {
//---------------------------------------------------------read file "logo" and add it to logoBookShopPanel and sets size into it.	
private BufferedImage logo;
	
	public logoBookShopPanel(String imagePath) {
